...
class NigerianSMEDatasetGenerator:
    ...
    def generate_innovation_adoption(self):
        ...
        advanced_tech += (self.data['owner_education'] == 'Master').astype(int) * 0.5
        advanced_tech += (self.data['owner_education'] == 'PhD').astype(int) * 0.8
        ...
        digitization += (self.data['location_type'] == 'Urban').astype(int) * 0.3
        ...
        process_innovation += (self.data['num_employees'] > 10).astype(int) * 0.4  # Larger firms more likely
        process_innovation += (self.data['industry'] == 'Manufacturing').astype(int) * 0.3
        ...
        product_innovation += (self.data['industry'] == 'IT Services').astype(int) * 0.5
        product_innovation += (self.data['industry'] == 'Manufacturing').astype(int) * 0.3
        product_innovation += (self.data['firm_age_years'] < 5).astype(int) * 0.2  # Newer firms more innovative
        ...
        business_model_innovation += (self.data['industry'] == 'IT Services').astype(int) * 0.6
        business_model_innovation += (self.data['industry'] == 'Retail Trade').astype(int) * 0.3
        ...
        competitive_pressure += (self.data['industry'] == 'Retail Trade').astype(int) * 0.5
        competitive_pressure += (self.data['industry'] == 'IT Services').astype(int) * 0.3
        ...
        customer_demand += (self.data['industry'] == 'IT Services').astype(int) * 0.6
        customer_demand += (self.data['location_type'] == 'Urban').astype(int) * 0.3
        ...
        mgmt_attitude += (self.data['owner_education'] == 'Master').astype(int) * 0.4
        mgmt_attitude += (self.data['owner_education'] == 'PhD').astype(int) * 0.6
        mgmt_attitude += (self.data['owner_age'] < 40).astype(int) * 0.2
    ...
    def generate_constraints(self):
        ...
        financial_constraints += (self.data['annual_turnover_ngn'] < 5000000).astype(int) * 0.5  # Smaller firms more constrained
        financial_constraints += (self.data['legal_structure'] == 'Sole Proprietorship').astype(int) * 0.3
        ...
        credit_access += (self.data['annual_turnover_ngn'] > 10000000).astype(int) * 0.8  # Larger firms better access
        credit_access += (self.data['legal_structure'] == 'Limited Liability Company').astype(int) * 0.5
        credit_access += (self.data['location_type'] == 'Urban').astype(int) * 0.3
        ...
        innovation_cost += (self.data['industry'] == 'IT Services').astype(int) * 0.3
        innovation_cost += (self.data['location_type'] == 'Rural').astype(int) * 0.2
        ...
        internal_capital += (self.data['annual_turnover_ngn'] > 5000000).astype(int) * 0.6
        internal_capital += (self.data['firm_age_years'] > 5).astype(int) * 0.3
        ...
        human_capital_constraints += (self.data['location_type'] == 'Rural').astype(int) * 0.4
        human_capital_constraints += (self.data['industry'] == 'IT Services').astype(int) * 0.5
        human_capital_constraints += (self.data['annual_turnover_ngn'] < 2000000).astype(int) * 0.3
        ...
        skilled_employee_difficulty += (self.data['location_type'] == 'Rural').astype(int) * 0.5
        skilled_employee_difficulty += (self.data['industry'] == 'IT Services').astype(int) * 0.4
        ...
        training_cost += (self.data['industry'] == 'IT Services').astype(int) * 0.3
        training_cost += (self.data['location_type'] == 'Rural').astype(int) * 0.2
        ...
        mgmt_capability += (self.data['owner_education'] == 'Master').astype(int) * 0.4
        mgmt_capability += (self.data['owner_education'] == 'PhD').astype(int) * 0.6
        mgmt_capability += (self.data['prior_entrepreneurial_experience'] > 5).astype(int) * 0.3
        ...
        infrastructure_constraints += np.array([1 if x == 'Rural' else 0 for x in self.data['location_type']]) * 0.6
        infrastructure_constraints += np.array([1 if x == 'North-East' else 0 for x in self.data['geo_political_zone']]) * 0.3
        infrastructure_constraints += np.array([1 if x == 'North-West' else 0 for x in self.data['geo_political_zone']]) * 0.2
        ...
        electricity_reliability += (self.data['location_type'] == 'Urban').astype(int) * 0.5
        electricity_reliability += (self.data['state'] == 'Lagos').astype(int) * 0.3
        ...
        internet_quality += (self.data['location_type'] == 'Urban').astype(int) * 0.6
        internet_quality += (self.data['state'] == 'Lagos').astype(int) * 0.4
        internet_quality += (self.data['state'] == 'Abuja').astype(int) * 0.3
        ...
        internet_cost += (self.data['location_type'] == 'Rural').astype(int) * 0.3
        ...
        logistics_access += (self.data['location_type'] == 'Urban').astype(int) * 0.5
        logistics_access += (self.data['state'] == 'Lagos').astype(int) * 0.4
        ...
        regulatory_constraints += (self.data['legal_structure'] == 'Limited Liability Company').astype(int) * 0.3
        regulatory_constraints += (self.data['annual_turnover_ngn'] > 10000000).astype(int) * 0.2
        ...
        regulation_burden += (self.data['legal_structure'] == 'Limited Liability Company').astype(int) * 0.4
        ...
        corruption_level += (self.data['location_type'] == 'Rural').astype(int) * 0.2
        ...
        gov_support_effectiveness += (self.data['location_type'] == 'Urban').astype(int) * 0.3
        ...
        market_constraints += (self.data['industry'] == 'Manufacturing').astype(int) * 0.3
        market_constraints += (self.data['location_type'] == 'Rural').astype(int) * 0.2
        ...
        competition_intensity += (self.data['industry'] == 'Retail Trade').astype(int) * 0.4
        competition_intensity += (self.data['industry'] == 'IT Services').astype(int) * 0.3
        competition_intensity += (self.data['location_type'] == 'Urban').astype(int) * 0.2
        ...
        demand_uncertainty += (self.data['industry'] == 'Agriculture').astype(int) * 0.4
        demand_uncertainty += (self.data['firm_age_years'] < 3).astype(int) * 0.3
        ...
        intl_market_access += (self.data['annual_turnover_ngn'] > 20000000).astype(int) * 0.8
        intl_market_access += (self.data['industry'] == 'Manufacturing').astype(int) * 0.4
        intl_market_access += (self.data['location_type'] == 'Urban').astype(int) * 0.3
